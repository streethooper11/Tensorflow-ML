...
# Trains the model with the given input training data and output training data
def train_model(input_train, output_train):
    # make model; model has 6 1-dimensional inputs and 1 output
    ...
    # fit model
    model_result.fit(input_train, output_train, epochs=10, verbose=2)
...
if __name__ == '__main__':
    ...
    # Main Project Stage 2 starts here
    (x_train, x_test, y_train, y_test) = sklearn.model_selection.train_test_split(
        cleaned_data[['Age', 'RestingBP', 'Cholesterol', 'FastingBS', 'MaxHR', 'Oldpeak']],
        cleaned_data['HeartDisease'],
        random_state=0,
        train_size=0.8
